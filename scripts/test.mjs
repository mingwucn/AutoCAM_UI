...
const result=spawnSync(process.execPath,['--test','--test-reporter=tap',...args.slice(2)],{cwd:root,env:{...process.env,...fixtures.environment,...allowance.environment},encoding:'utf8',maxBuffer:16*1024**2});
