...
export function AdaptiveInspector({prepared,onClose,live=null,initialStock=false,sourceInspection=null}){
  ...
  const periodic=construction?.schema==='adaptive-periodic-construction-1',spherical=construction?.schema==='adaptive-spherical-construction-1';
